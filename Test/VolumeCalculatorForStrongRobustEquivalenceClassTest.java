...
public class VolumeCalculatorForStrongRobustEquivalenceClassTest {
    ...
    public static Iterable<Integer[] > testCasesGenerator() {
        return VolumeCalculatorTestCasesGenerator.generateStrongRobustEquivalenceClassTestCases();
    }
